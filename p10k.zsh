# Generated by Powerlevel10k configuration wizard on 2024-01-17 at 14:30 CET.
...
# disconnected, full frame, compact, concise, instant_prompt=verbose.
...
() {
  ...
  function my_git_formatter() {
    ...
    (( VCS_STATUS_NUM_UNSTAGED   )) && res+=" ${modified}${(g::)POWERLEVEL9K_VCS_STAGED_ICON}${VCS_STATUS_NUM_UNSTAGED}"
